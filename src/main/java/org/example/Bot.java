...
public class Bot {
    ...
    private final String PROCESSING_LABEL = "Загрузка...";
    ...
    private void process(Update update) {
        ...
        if (message != null && message.viaBot() != null && message.viaBot().username().equals("firstGameCool_bot")) {
            ...
            InlineQueryResultArticle stone = buildInlineButton("бумага", " ✋ Бумага", "0");
            InlineQueryResultArticle scissors = buildInlineButton("ножницы", " ✌ Ножницы", "1");
            InlineQueryResultArticle paper = buildInlineButton("камень", " ✊ Камень", "2");
            ...
            if (senderChose.equals(opponentChose)) {
                ...
                request = new SendMessage(chatId, String.format("%s (%s) был побит %s (%s)",
    ...
    private InlineQueryResultArticle buildInlineButton(String id, String title, String callbackData) {
        return new InlineQueryResultArticle(id, title, "Я готов к сражению")
